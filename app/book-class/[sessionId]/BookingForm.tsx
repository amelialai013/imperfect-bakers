    ...
    return (
      <div className="max-w-xl">
        ...
        <p className="text-[#6b7280] text-sm leading-relaxed mb-10 max-w-sm">
          We confirm classes once we have enough students signed up. Please note this is not confirmation of your booking — an email will be sent to confirm your reservation once the class is finalised.
        </p>
