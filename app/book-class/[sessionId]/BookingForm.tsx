...
export default function BookingForm({ session }: { session: ClassSession }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-[1fr_260px] md:grid-cols-[1fr_300px] lg:grid-cols-[1fr_320px] gap-[60px] sm:gap-8 md:gap-12 lg:gap-20 items-start">
        ...
        <div className="mt-8 pt-2 flex flex-col gap-6">
          ...
          <div className="flex gap-3 rounded-xl border border-[#006644]/20 bg-[#006644]/6 px-5 py-4">
            ...
            <p className="text-sm text-[#1a1a1a] leading-relaxed">
              <span className="font-semibold">Please note —</span>{" "}classes are confirmed once minimum numbers are met. You will receive an email confirming whether your class is going ahead. We&apos;ll be in touch soon!
            </p>
          </div>
        </div>
      ...
      <div className="order-first sm:order-last sm:sticky sm:top-28" style={{ pointerEvents: "none" }}>
        <div className="bg-[#006644] rounded-2xl py-6 px-8 sm:px-0 lg:px-8 text-white flex flex-col sm:flex-row lg:flex-col">
          {/* Session info */}
          <div className="sm:flex-1 sm:min-w-0 sm:px-8 lg:px-0 sm:border-r sm:border-white/10 lg:border-r-0">
          ...
          {session.skills && session.skills.length > 0 && (
            <>
              {/* Horizontal divider on mobile/desktop only; sm+ uses border-r on left column */}
              <div className="h-px bg-white/10 my-6 sm:hidden lg:block" />
              <div className="sm:flex-1 sm:min-w-0 sm:px-8 lg:flex-none lg:px-0">
