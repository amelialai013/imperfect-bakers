...
function SessionCard({ s, view }: { s: import("@/lib/types").ClassSession; view: "grid" | "list" }) {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="hidden sm:flex px-8 pt-4 pb-4 gap-6">
            <div className="flex-1 min-w-0">
              ...
              {s.location && (
                <span className="flex items-center gap-1 mt-2 text-[#6b7280] text-xs min-w-0">
  ...
  return (
    ...
    >
      ...
      >
        <div className={`h-1 w-full ${isFull ? "bg-[#c8c0b4]" : "bg-[#006644]"}`} />
        <div className="pt-4 px-8 pb-4 flex flex-col flex-1">
          ...
          <div className="mt-2">
            <h3 className="text-[#1a1a1a] text-lg font-medium leading-snug mb-2" style={{ fontFamily: "var(--font-dm-sans), system-ui, sans-serif" }}>
              {s.sessionName || s.classLabel}
            </h3>
