      ...
      >
        ...
        >
          ...
          <div className="hidden sm:flex px-4 pt-[9px] pb-4 gap-6">
            ...
            <div className="flex items-center gap-5 text-sm text-[#6b7280] shrink-0 self-center mt-[1px]">
            ...
            <div className="flex items-center gap-4 shrink-0 self-center mt-[1px]">
              {!isFull ? (
