...
function SessionCard({ s, view }: { s: import("@/lib/types").ClassSession; view: "grid" | "list" }) {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="hidden sm:flex px-4 pt-1 pb-4 gap-6">
            <div className="flex-1 min-w-0">
              ...
              {s.location && (
                <span className="flex items-center gap-1 mt-[4px] text-[#6b7280] text-xs min-w-0">
  ...
  return (
    ...
    >
      ...
      >
        <div className={`h-1 w-full ${isFull ? "bg-[#c8c0b4]" : "bg-[#006644]"}`} />
        <div className="pt-1 px-4 pb-4 flex flex-col flex-1">
