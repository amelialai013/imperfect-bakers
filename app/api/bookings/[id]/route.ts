          ...
          <div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;color:#1a1a1a">
            ...
            <div style="background:#faf9f6;padding:32px;border-radius:0 0 12px 12px;border:1px solid #e4dfd5;border-top:none">
              ...
              <p style="font-size:15px;color:#374151;line-height:1.7;margin-bottom:24px">
                Your spot has been released and you won't be charged. We'd love to see you at a future session — check out what's coming up below!
              </p>
...
async function sendEmail({ to, subject, html }: { to: string; subject: string; html: string }) {
  ...
  const res = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({ from: process.env.RESEND_FROM_EMAIL ?? "Imperfect Bakers <onboarding@resend.dev>", to: [to], subject, html }),
  });
