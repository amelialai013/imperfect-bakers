                ...
                <div className="absolute inset-0 flex flex-col justify-start p-8 md:p-10">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-white/70 text-sm leading-relaxed mt-4 max-w-md opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 line-clamp-2">
                        {c.desc}
                      </p>
                    </div>
