  ...
  return (
    <section className="bg-[#006644] py-24">
      <div className="max-w-7xl mx-auto px-8">
        ...
        {/* Label */}
        <span className="block text-[0.6875rem] font-semibold tracking-[0.2em] uppercase text-white/40 mb-10">
          Testimonials
        </span>
        ...
        <div className="mt-14 pt-10 border-t border-white/10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <p className="text-white/60 text-sm leading-relaxed max-w-xs">
            Had a great experience?<br />Your review helps other families find us.
          </p>
          <a
